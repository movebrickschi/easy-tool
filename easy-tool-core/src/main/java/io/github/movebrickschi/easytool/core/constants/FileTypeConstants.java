...
public final class FileTypeConstants {
    ...
    public enum VideoPool {
        ...
        public static FileTypeConstants.VideoPool getVideoPool(String type) {
            return Arrays.stream(FileTypeConstants.VideoPool.values()).filter(item -> type.equalsIgnoreCase(item.getType()))
                    .findFirst()
    ...
    public enum ImagePool {
        ...
        public static FileTypeConstants.ImagePool getImagePool(String type) {
            return Arrays.stream(FileTypeConstants.ImagePool.values())
