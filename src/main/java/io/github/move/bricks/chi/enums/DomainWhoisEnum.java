package io.github.move.bricks.chi.enums;

import io.github.move.bricks.chi.vo.DomainStatusVO;
...
public final class DomainWhoisEnum {
    ...
    public enum DomainStatus {
         ...
         *
         */
        SERVER_TRANSFER_PROHIBITED(0, "serverTransferProhibited", "注册局设置禁止转移",
                                            "表示限制域名的一种状态，域名不能转移注册商。部分新注册的域名或域名转移注册商60天内会被注册局设置禁止转移，60天后会自动解除该状态；部分域名涉及仲裁或诉讼案被注册局设置禁止转移，仲裁或诉讼案结束会解除该状态。"),
        /**
         * 其他禁止解析、禁止续费的状态。
         */
